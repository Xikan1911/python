...
my_food = ['pizza', 'falafel', 'carrot cake', 'carrot']
frend_food = my_food[:]
my_food.append('cannoli')
frend_food.append('ice cream')
print("My favorit food:")
for my_food in my_food:
    print(my_food)
print("My favorit freind food:")
for frend_food in frend_food:
    print(frend_food)